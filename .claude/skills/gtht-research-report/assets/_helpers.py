...
# 模板：默认用 skill 自带的模板，可用 DOCX_TPL 覆盖
TPL = os.environ.get('DOCX_TPL', os.path.join(_HERE, '报告模板.docx'))
# 输出路径
OUT = os.environ.get('DOCX_OUT', os.path.join(os.getcwd(), 'out.docx'))
# 图片目录（figure() 从这里取图），末尾需带分隔符
CH  = os.environ.get('DOCX_CHARTS', os.path.join(os.getcwd(), 'charts')) + os.sep
