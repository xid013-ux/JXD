...
SPECS = {
    ...
    '表2': dict(
        headers=['企业', '气体喷淋头（匀气盘）的进展'],
        rows=[
            ['富创精密', '报告期内完成多款高度集成化新型匀气盘产品研发落地，'
                         '多层钎焊内腔匀气盘实现全流程自主可控生产；匀气盘业务同比翻倍，'
                         '高难度、复杂结构产品已在国内先进制程领域导入与推广'],
            ['先锋精科', '匀气盘为其半导体类主要产品之一，微孔加工的孔径标准差可达 0.3 微米；'
                         '真空扩散焊与真空钎焊应用于多层复杂构造匀气盘的生产'],
        ],
        widths=[16, 84],
        aligns=['center', 'left'],
        caption='表2  国内主要厂商气体喷淋头的进展',
        source='资料来源：各公司 2026 年半年度报告。'
               '注：江丰电子 2026 年半年度报告将气体分配盘列为国内供应链'
               '仍处于持续突破阶段的金属零部件之一。',
    ),
    '表3': dict(
        headers=['企业', '陶瓷加热盘的进展'],
