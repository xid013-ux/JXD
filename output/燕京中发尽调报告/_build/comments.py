...
COMMENTS = [
    ...
    ("解决路径有两条", "50A38C7A", "5B79A38A",
     ...
     "该公司持有全部四宗宗地272.85亩及地上厂房，工商登记显示其7,300.00万元注册资本已全额实缴，落入第二档存在较大可能，请优先落实。"
     "但这只是初步判断：工商公示的实缴出资额未经登记机关核验，土地厂房取得于2009年至2015年、已计提多年摊销折旧，"
     "账面资产总额与实际价值可能相差较大，仍以实际报表数据为准。"
     "其余待核事项："
